...
/******/ (function (modules) {
  ...
  /******/[
                  ...
                  switch ((_context2.prev = _context2.next)) {
                    ...
                    case 6:
                      ...
                      if (
                        !(
                          name in OVERRIDES &&
                          _app_options.AppOptions.get(name) ===
                          OVERRIDES[name]
                        )
                      ) {
                        _context2.next = 10;
                ...
                while (1) {
                  switch ((_context5.prev = _context5.next)) {
                    case 0:
                      ...
                      this.overlayManager =
                        new _overlay_manager.OverlayManager();
                      dispatchToDOM = _app_options.AppOptions.get(
                        "eventBusDispatchToDOM"
                      );
                      eventBus =
                        appConfig.eventBus ||
                        (0, _dom_events.getGlobalEventBus)(dispatchToDOM);
                      ...
                      this.passwordPrompt =
                        new _password_prompt.PasswordPrompt(
                      ...
                      sidebarConfig.pdfThumbnailViewer =
                        this.pdfThumbnailViewer;
              ...
              function _callee7$(_context7) {
                while (1) {
                  switch ((_context7.prev = _context7.next)) {
                    ...
                    case 3:
                      workerParameters =
                        _app_options.AppOptions.getAll("worker");
        ...
        load: function load(pdfDocument) {
          ...
          firstPagePromise.then(function (pdfPage) {
            ...
            if (
              ...
              var resetHistory = !_app_options.AppOptions.get(
                "showPreviousViewOnLoad"
              );
              _this5.pdfHistory.initialize(
                pdfDocument.fingerprint,
                resetHistory
              );
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      exports.moveToEndOfArray =
        exports.waitOnEventOrTimeout =
        exports.WaitOnType =
        exports.animationStarted =
        exports.normalizeWheelEventDelta =
        exports.binarySearchFirstItem =
        exports.watchScroll =
        exports.scrollIntoView =
        exports.getOutputScale =
        exports.approximateFraction =
        exports.getPageSizeInches =
        exports.roundToDivide =
        exports.getVisibleElements =
        exports.backtrackBeforeAllVisibleElements =
        exports.parseQueryString =
        exports.noContextMenuHandler =
        exports.getPDFFileNameFromURL =
        exports.ProgressBar =
        exports.EventBus =
        exports.NullL10n =
        ...
        exports.isPortraitOrientation =
        exports.isValidRotation =
      ...
      var EventBus = (function () {
        function EventBus() {
          var _ref7 =
            ...
            dispatchToDOM =
              _ref7$dispatchToDOM === undefined ? false : _ref7$dispatchToDOM;
      ...
      var PDFCursorTools = (function () {
        function PDFCursorTools(_ref) {
          ...
          var container = _ref.container,
            ...
            cursorToolOnLoad =
              _ref$cursorToolOnLoad === undefined
                ? CursorTool.SELECT
          ...
          },
          {
            ...
            value: function getAll() {
              ...
              for (var name in defaultOptions) {
                ...
                options[name] =
                  userOption !== undefined ? userOption : defaultOption.value;
              }
              return options;
            },
          },
            ...
            value: function render(_ref2) {
              var attachments = _ref2.attachments,
                ...
                keepRenderedCapability =
                  _ref2$keepRenderedCap === undefined
                    ? false
          ...
          },
          {
            ...
            value: function updateResultsCount() {
              ...
              Promise.resolve(matchesCountMsg).then(function (msg) {
                ...
                _this3.findResultsCount.classList[!total ? "add" : "remove"](
                  "hidden"
                );
                _this3._adjustWidth();
              });
      ...
      var PDFFindController = (function () {
        function PDFFindController(_ref) {
          var linkService = _ref.linkService,
            ...
            eventBus =
              _ref$eventBus === undefined
                ? (0, _dom_events.getGlobalEventBus)()
                : _ref$eventBus;
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      exports.isDestArraysEqual =
        exports.isDestHashesEqual =
        exports.PDFHistory =
        undefined;
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var PDFLinkService = (function () {
        function PDFLinkService() {
          var _ref =
            ...
            externalLinkTarget =
              _ref$externalLinkTarg === undefined
                ? null
                : _ref$externalLinkTarg,
            _ref$externalLinkRel = _ref.externalLinkRel,
            externalLinkRel =
              _ref$externalLinkRel === undefined ? null : _ref$externalLinkRel;
              ...
              var goToDestination = function goToDestination(_ref2) {
                ...
                if (destRef instanceof Object) {
                  ...
                  console.error(
                    ...
                    destRef +
                    '" is not ' +
                    ('a valid destination reference, for dest="' +
                      dest +
                      '".')
                  );
                  return;
              ...
              new Promise(function (resolve, reject) {
                ...
                if (!Array.isArray(data.explicitDest)) {
                  console.error(
                    ...
                    data.explicitDest +
                    '" is' +
                    (' not a valid destination array, for dest="' +
                      dest +
                      '".')
                  );
                  return;
      ...
      function isValidExplicitDestination(dest) {
        ...
        if (
          !(
            (typeof page === "undefined" ? "undefined" : _typeof(page)) ===
            "object" &&
        ...
        if (
          !(
            (typeof zoom === "undefined" ? "undefined" : _typeof(zoom)) ===
            "object" && typeof zoom.name === "string"
          )
        ) {
          return false;
        }
          ...
          },
          {
            ...
            value: function _addToggleButton(div) {
              ...
              toggler.onclick = function (evt) {
                ...
                if (evt.shiftKey) {
                  var shouldShowAll =
                    !toggler.classList.contains("outlineItemsHidden");
      ...
      var PDFPresentationMode = (function () {
        function PDFPresentationMode(_ref) {
          ...
          var container = _ref.container,
            ...
            contextMenuItems =
              _ref$contextMenuItems === undefined
                ? null
        ...
        function PDFThumbnailView(_ref) {
          var container = _ref.container,
            ...
            disableCanvasToImageConversion =
              _ref$disableCanvasToI === undefined
                ? false
      ...
      var PDFViewer = (function (_BaseViewer) {
        ...
        function PDFViewer() {
          ...
          return _possibleConstructorReturn(
            this,
            (PDFViewer.__proto__ || Object.getPrototypeOf(PDFViewer)).apply(
              this,
              arguments
            )
          );
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var BaseViewer = (function () {
        function BaseViewer(options) {
          ...
          this.eventBus =
            options.eventBus || (0, _dom_events.getGlobalEventBus)();
          this.linkService =
          ...
          },
          {
            ...
            value: function _scrollIntoView(_ref) {
              var pageDiv = _ref.pageDiv,
                ...
                pageNumber =
                  _ref$pageNumber === undefined ? null : _ref$pageNumber;
              ...
              if (scale > 0) {
                ...
                switch (value) {
                  ...
                  case "page-fit":
                    ...
                    break;
                  case "auto":
                    var horizontalScale = (0, _ui_utils.isPortraitOrientation)(
                      currentPage
                    )
                      ? pageWidthScale
      ...
      var AnnotationLayerBuilder = (function () {
        function AnnotationLayerBuilder(_ref) {
          var pageDiv = _ref.pageDiv,
            ...
            imageResourcesPath =
              _ref$imageResourcesPa === undefined ? "" : _ref$imageResourcesPa,
            _ref$renderInteractiv = _ref.renderInteractiveForms,
            renderInteractiveForms =
              _ref$renderInteractiv === undefined
                ? false
        ...
        _createClass(PDFPageView, [
          {
            ...
            value: function setPdfPage(pdfPage) {
              ...
              this.viewport = pdfPage.getViewport(
                this.scale * _ui_utils.CSS_UNITS,
                totalRotation
              );
          ...
          },
          {
            ...
            value: function cancelRendering() {
              ...
              if (
                renderingState !== _pdf_rendering_queue.RenderingStates.INITIAL
              ) {
      ...
      var TextLayerBuilder = (function () {
        function TextLayerBuilder(_ref) {
          var textLayerDiv = _ref.textLayerDiv,
            ...
            findController =
              _ref$findController === undefined ? null : _ref$findController,
            _ref$enhanceTextSelec = _ref.enhanceTextSelection,
            enhanceTextSelection =
              _ref$enhanceTextSelec === undefined
                ? false
        ...
        _createClass(TextLayerBuilder, [
          ...
          },
          {
            ...
            value: function updateMatches() {
              ...
              if (
                !this.findController ||
                !this.findController.highlightMatches
              ) {
                return;
              }
            ...
            value: function _bindScrollModeListener(buttons) {
              ...
              function scrollModeChanged(evt) {
                ...
                var isScrollModeHorizontal =
                  evt.mode === _base_viewer.ScrollMode.HORIZONTAL;
      ...
      var PDFSinglePageViewer = (function (_BaseViewer) {
        ...
        function PDFSinglePageViewer(options) {
          ...
          var _this = _possibleConstructorReturn(
            this,
            (
              PDFSinglePageViewer.__proto__ ||
              Object.getPrototypeOf(PDFSinglePageViewer)
            ).call(this, options)
          );
        ...
        _createClass(PDFSinglePageViewer, [
          {
            ...
            value: function _resetView() {
              _get(
                PDFSinglePageViewer.prototype.__proto__ ||
                Object.getPrototypeOf(PDFSinglePageViewer.prototype),
                "_resetView",
                this
              ).call(this);
      ...
      var ViewHistory = (function () {
        function ViewHistory(fingerprint) {
          ...
          this._initializedPromise = this._readFromStorage().then(function (
            ...
            if (index === -1) {
              index =
                database.files.push({ fingerprint: _this.fingerprint }) - 1;
            }
      ...
      var GenericPreferences = (function (_BasePreferences) {
        ...
        function GenericPreferences() {
          ...
          return _possibleConstructorReturn(
            this,
            (
              GenericPreferences.__proto__ ||
              Object.getPrototypeOf(GenericPreferences)
      ...
      var DownloadManager = (function () {
        function DownloadManager(_ref) {
          var _ref$disableCreateObj = _ref.disableCreateObjectURL,
            disableCreateObjectURL =
              _ref$disableCreateObj === undefined
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      function renderProgress(index, total, l10n) {
        ...
        l10n
          .get("print_progress_percent", { progress: progress }, progress + "%")
          .then(function (msg) {
